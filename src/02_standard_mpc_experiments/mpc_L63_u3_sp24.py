...
system.main()
np.save(pwd+"/../../data/x_tru_u3", system.x_tru)
np.save(pwd+"/../../data/y_o_u3", system.y_o)
np.save(pwd+"/../../data/X_a_u3", system.X_a)
np.save(pwd+"/../../data/X_b_u3", system.X_b)
np.save(pwd+"/../../data/u_tru_u3", system.u_tru)
np.save(pwd+"/../../data/u_tru_norm_u3", system.u_tru_norm)
with open(pwd+"/../../data/x_opt_list_list_u3", mode="wb") as f : 
    pickle.dump(system.x_opt_list_list, f)
with open(pwd+"/../../data/u_opt_list_list_u3", mode="wb") as f : 
