...
system.main()
np.save(pwd+"/../../data/x_tru_u3_umax"+str(system.U_NORM_MAX), system.x_tru)
# np.save(pwd+"/../../data/y_o_u3_umax"+str(system.U_NORM_MAX), system.y_o)
# np.save(pwd+"/../../data/X_a_u3_umax"+str(system.U_NORM_MAX), system.X_a)
# np.save(pwd+"/../../data/X_b_u3_umax"+str(system.U_NORM_MAX), system.X_b)
# np.save(pwd+"/../../data/u_tru_u3_umax"+str(system.U_NORM_MAX), system.u_tru)
np.save(pwd+"/../../data/u_tru_norm_u3_umax"+str(system.U_NORM_MAX), system.u_tru_norm)
# with open(pwd+"/../../data/x_opt_list_list_u3_umax"+str(system.U_NORM_MAX), mode="wb") as f : 
    # pickle.dump(system.x_opt_list_list, f)
# with open(pwd+"/../../data/u_opt_list_list_u3_umax"+str(system.U_NORM_MAX), mode="wb") as f : 
